...
export class AboutComponent implements OnInit {
  journey=[
  {src:'/assets/walking.png', title:'The JOURNEY began', text:'I started programming as a hobby when I was 14 years old and I still enjoy programming immensely.'},
  ...
  {src:'/assets/takeoff.png', title:'Ready to takeoff', text:'I am now looking for new challenges to work as a Front End developer.'},
]
  constructor() { }
